...
export function RedeemScreen({ onBack }: RedeemScreenProps) {
  ...
  const handleRedeem = () => {
    Alert.alert(
      '💰 Redeem Winnings',
      'This will redeem all your winning Polymarket positions. Continue?',
      [
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.scrollContent}>
        ...
        <Card>
          ...
          <Text style={styles.description}>
            If you have winning positions on markets that have resolved, you can
            redeem them here to receive your payout in USDC.
          </Text>
        </Card>

        {/* Check Positions */}
        <Button
          title="Check Redeemable Positions"
        ...
        {positions && (
          <Card>
            <Text style={styles.positionsLabel}>Your Positions</Text>
        ...
        <Text style={styles.note}>
          Note: Only resolved winning positions can be redeemed.
        </Text>
      </ScrollView>
    </View>
  );
